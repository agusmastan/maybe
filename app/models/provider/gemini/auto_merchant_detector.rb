class Provider::Gemini::AutoMerchantDetector
  ...
  def auto_detect_merchants
    ...
    Rails.logger.info("Tokens used to auto-detect merchants: #{response.dig("usageMetadata", "totalTokenCount")}")
  ...
  private
    ...
    def normalize_ai_value(ai_value)
      return nil if ai_value == "null" || ai_value.nil? || ai_value.to_s.strip.empty?
    ...
    def extract_merchants(response)
      ...
      response_json.dig("merchants") || response_json
    end
